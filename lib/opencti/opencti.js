...
/******/ ([
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        module.exports = {
             ...
             * @param {Object} args - An object holding arguments for calls to this method.
             * @param {string} args.eventName - The name of the to-be-dispatched event.
             * @param {string} args.payload - The payload of the to-be-dispatched event.
             */
            dispatchGlobalEvent: function dispatchGlobalEvent(args) {
                utils.validateArguments(arguments);
                utils.validateEventName(args);
                utils.validatePayload(args);

                utils.invokeApiCall('dispatchGlobalEvent', {
             ...
             * @param {Object} args - An object holding arguments for calls to this method.
             * @param {string} args.eventName - The name of a global event to which the listener will be bound.
             * @param {Function} args.listener - A listener function bound to the specified global event.
             */
            addGlobalEventListener: function addGlobalEventListener(args) {
                utils.validateArguments(arguments);
                utils.validateEventName(args);
                utils.validateListener(args);

                utils.invokeApiCall('addGlobalEventListener', {
                    eventName: args.eventName
                }, undefined, args.listener);
            },

            /**
             * Unregister a listener for a global event.
             * @param {Object} args - An object holding arguments for calls to this method.
             * @param {string} args.eventName - The name of a global event to which the listener will be unregistered.
             * @param {Function} args.listener - A listener function which will be unregistered from the specified global event.
             */
            removeGlobalEventListener: function removeGlobalEventListener(args) {
                utils.validateArguments(arguments);
                utils.validateEventName(args);
                utils.validateListener(args);

                listenerManager.unregisterListener('addGlobalEventListener', args.eventName, args.listener);

                if (!listenerManager.getListenerCount('addGlobalEventListener', args.eventName)) {
                    utils.invokeApiCall('removeGlobalEventListener', {
                        eventName: args.eventName
                    });
                }
            }
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var validateEventName = function validateEventName(args) {
            if (!(args && typeof args.eventName === 'string' && args.eventName)) {
